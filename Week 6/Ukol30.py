...
# Pokud jsi tento příklad nezpracovala, ulož libovolnou jinou tabulku jako Excel sešit. Výsledný sešit si
# otevři a zkontroluj. K uložení použij funkci to_excel, se kterou pracuj stejně, jako jsme na lekci pracovali s
# funkci to_csv.
...
#
# Zkus pomocí modulu zapsat rozvrh hodin jako tabulku v Excel sešitu. Níže máš program, který obsahuje rozvrh
# hodin jako dvourozměrný seznam. Vnitřní seznamy obsahují předměty v rozvrhu, jeden vnitřní seznam vždy
# obsahuje předměty pro daný den.
#
# Podívej se nejprve na ukázku. Jednoduchý program níže zapíše hodnotu Test do buňky B1 a výsledek uloží
# souboru rozvrh_hodin.xlsx. Pokud neznáš terminologii Excelu, pak Workbook označuje sešit, tj. celý "soubor".
# ws se odkazuje na Work Sheet, což je list, tj. jedna "záložka". Náš soubor bude mít jen jeden list, čímž je situace
# jednoduchá.
#
